...
\begin{itemize}
	\item
	      \textbf{Resume Profile}
	      \begin{itemize}
	      	\vspace{-2mm} \setlength\itemsep{-0.7mm}
		\item Outstanding student with experiences ranging from administrating servers, desiging graphics, producing film, and developing software.
	      \end{itemize}
	\item
	      \textbf{Education}
	      \hfill \textit{2017}
	      \begin{itemize}
	      	\vspace{-2mm} \setlength\itemsep{-0.7mm}
		\item Advance Studies Diploma at John Champe High School.
		\item Graduated with a G.P.A of 3.75 and was top 20 percent of class.
		\item Attending James Madison Univerisity since the fall of 2017.
		\item Pursuing a major in Computer Science.
	      \end{itemize}
\end{itemize}
...
\begin{itemize}
	\item
	      \textbf{Virtual Tour} Lead Coordinator
	      \hfill \textit{May 2017}
	      \begin{itemize}
	      	\vspace{-2mm} \setlength\itemsep{-0.7mm}
		\item Facilitated 4 students to learn the programs needed to create the final solution.
		\item Guided a team to successfully create and complete the project at hand.
	      \end{itemize}
	\item
